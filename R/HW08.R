...
USGS02055000=make_usgs_gage_list(siteNo ="02055100" )
...
#USGS0205551460$flowdata=USGS0205551460$flowdata[,c(1,2,3,4,5,8,10)]
#View(USGS0205551460$flowdata)
...
plot(USGS0205551460$rating$DEP,USGS0205551460$rating$INDEP)
#
