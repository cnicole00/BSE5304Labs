...
# Change Pusle values according to slope in table 4:1-2
MUSLE$Pusle_slp=c(0.6,0.5,0.5,0.6,0.6)
MUSLE$KCPLSCFRG118_slp=11.8*Kusle*Cusle*Pusle_slp*LS*CFRG
detach(MUSLE)
...
# may need to invert this for hw
...
TIC01$sed_slp=(TIC01$Qpred*TIC01$qpeak*myflowgage$area/nTIclass*100)^.56*MUSLE$KCPLSCFRG118_slp[1]
plot(TIC01$date,TIC01$sed,xlab="date",ylab="sediment in metric tons/ha")
points(TIC01$date,TIC01$sed_slp,col="red")
legend(x="topleft",
       legend=c("TIC01$sed","TIC01$sed_slp"),
       col=c("black","red"),
       lwd=2)
...
TIC02$sed_slp=(TIC02$Qpred*TIC02$qpeak*myflowgage$area/nTIclass*100)^.56*MUSLE$KCPLSCFRG118_slp[2]
plot(TIC02$date,TIC02$sed,xlab="date",ylab="sediment in metric tons/ha")
points(TIC02$date,TIC02$sed_slp,col="red")
legend(x="topleft",
       legend=c("TIC02$sed","TIC02$sed_slp"),
       col=c("black","red"),
       lwd=2)
...
TIC03$sed_slp=(TIC03$Qpred*TIC03$qpeak*myflowgage$area/nTIclass*100)^.56*MUSLE$KCPLSCFRG118_slp[3]
plot(TIC03$date,TIC03$sed,xlab="date",ylab="sediment in metric tons/ha")
points(TIC03$date,TIC03$sed_slp,col="red")
legend(x="topleft",
       legend=c("TIC03$sed","TIC03$sed_slp"),
       col=c("black","red"),
       lwd=2)
...
TIC04$sed_slp=(TIC04$Qpred*TIC04$qpeak*myflowgage$area/nTIclass*100)^.56*MUSLE$KCPLSCFRG118_slp[4]
plot(TIC04$date,TIC04$sed,xlab="date",ylab="sediment in metric tons/ha")
points(TIC04$date,TIC04$sed_slp,col="red")
legend(x="topleft",
       legend=c("TIC04$sed","TIC04$sed_slp"),
       col=c("black","red"),
       lwd=2)
...
TIC05$sed_slp=(TIC05$Qpred*TIC05$qpeak*myflowgage$area/nTIclass*100)^.56*MUSLE$KCPLSCFRG118_slp[5]
plot(TIC05$date,TIC05$sed,xlab="date",ylab="sediment in metric tons/ha")
points(TIC05$date,TIC05$sed_slp,col="red")
legend(x="topleft",
       legend=c("TIC05$sed","TIC05$sed_slp"),
       col=c("black","red"),
       lwd=2)

agg_sed=data.frame(date=TIC01$date, sed=TIC01$sed+TIC02$sed+TIC03$sed+TIC04$sed+TIC05$sed, sed_slp=TIC01$sed_slp+TIC02$sed_slp+TIC03$sed_slp+TIC04$sed_slp+TIC05$sed_slp)
plot(agg_sed$date,agg_sed$sed,xlab="date",ylab="aggregate sediment in metric tons/ha")
points(agg_sed$date,agg_sed$sed_slp,col="red")
legend(x="topleft",
       legend=c("agg_sed$sed","agg_sed$sed_slp"),
       col=c("black","red"),
       lwd=2)
