...
datadir=paste0(myhomedir,"/data",HWNo)
dir.create(datadir,recursive = T)
srcdir=paste0(myhomedir,"/src")
dir.create(srcdir,recursive = T)

mygitdir=rstudioapi::getActiveProject()
mypdfdir=paste0(mygitdir,"/pdfs",HWNo)
dir.create(mypdfdir)
# 
setwd(mygitdir)
...
myflowgage_id="01208950" 
myflowgage=get_usgs_gage(myflowgage_id,begin_date = "2015-01-01",
                         end_date = "2022-03-01")
print(myflowgage$area)
# Normalize Q in mm/day for basins
...
myflowgage$area * 10^3 * 10^3 / res(mydem)[1]^2 / targetbasins #get threshold - will be used later
...
# Run again after filling missing data with the mean of saturated conductivities, etc
par(mfrow=c(2,2))
plot(soilmap,y="ksat_r")
plot(soilmap,y="awc_r")
plot(soilmap,y="hzdepb_r") #horizon depth
...
source("https://raw.githubusercontent.com/cnicole00/BSE5304Labs/main/R/TMWBfuncs.R")
source("https://raw.githubusercontent.com/cnicole00/BSE5304Labs/main/R/TISnowFunc.R")
source("https://raw.githubusercontent.com/cnicole00/BSE5304Labs/main/R/TMWBModel.R")

SNO_df=TISnow(TMWB,SFTmp=2,bmlt6=3,bmlt12=3,Tmlt=3,Tlag=1)
TMWB$SNO=SNO_df$SNO
...
(1000/85-10)*25.4   # our CN storage estimate in bold
#[1] 44.82353
...
NSE(Qmm,Qpred)
Qprednew = dP^2/(dP+Sest) # Qpred using the optimized S
NSE(Qmm,Qprednew)
# 0.4162657
# hydrograph
plot(date,Qmm,col="black",type="l",ylab="Qmm(mm)")
lines(date,Qprednew,col="blue")
legend("topright", c("Qmm(mm)", "Qprednew(mm)"), col = c("black", "blue"),
       lty = 1:2, cex = 0.8)
########
detach(BasinTMWB_JO)
